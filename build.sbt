...
lazy val chipyard = (project in file("generators/chipyard"))
  ...
  .dependsOn(rocketchip, boom, hwacha, sifive_blocks, sifive_cache, iocell,
    ...
    gemmini, icenet, tracegen, cva6, nvdla, sodor, cgra4x3, cgra2x2, cgra6x6, stream2x2cgra, stream4x3cgra, stream6x6cgra, streamDouble4x3cgra, streamDouble6x6cgra)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(commonSettings)
...
lazy val cgra4x3 = (project in file("generators/cgra4x3"))
  .dependsOn(rocketchip, chisel_testers)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(libraryDependencies ++= chiselTestersLibDeps.value)
  .settings(commonSettings)

lazy val cgra2x2 = (project in file("generators/cgra2x2"))
  .dependsOn(rocketchip, chisel_testers)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(libraryDependencies ++= chiselTestersLibDeps.value)
  .settings(commonSettings)

lazy val stream2x2cgra = (project in file("generators/stream2x2cgra"))
  .dependsOn(rocketchip, chisel_testers)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(libraryDependencies ++= chiselTestersLibDeps.value)
  .settings(commonSettings)

lazy val stream4x3cgra = (project in file("generators/stream4x3cgra"))
  .dependsOn(rocketchip, chisel_testers)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(libraryDependencies ++= chiselTestersLibDeps.value)
  .settings(commonSettings)

lazy val stream6x6cgra = (project in file("generators/stream6x6cgra"))
  .dependsOn(rocketchip, chisel_testers)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(libraryDependencies ++= chiselTestersLibDeps.value)
  .settings(commonSettings)
...
lazy val tapeout = (project in file("./tools/barstools/tapeout/"))
  .dependsOn(chisel_testers, chipyard, cgra4x3, cgra2x2, cgra6x6, stream2x2cgra, stream4x3cgra, stream6x6cgra, streamDouble4x3cgra, streamDouble6x6cgra) // must depend on chipyard to get scala resources
  .settings(libraryDependencies ++= chiselTestersLibDeps.value)
  .settings(commonSettings)
